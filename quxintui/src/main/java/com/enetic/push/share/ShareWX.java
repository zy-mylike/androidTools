...
import com.enetic.push.utils.Util;
...
//                this.scene = SendMessageToWX.Req.WXSceneFavorite;
    ...
    public void addCall(ShareResultCall call) {
    ...
    public void init() {
        api = WXAPIFactory.createWXAPI(this.ctx, Constants.WXConstant.WXAPP_ID);
