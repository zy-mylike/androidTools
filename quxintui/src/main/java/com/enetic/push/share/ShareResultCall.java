...
public class ShareResultCall {
    ...
    public void onShareFailure(String errStr, int errCode) {     call=null;
    }

    public void onShareCancel() {     call=null;
    }

    public void onShareError(String errStr, int errCode) {     call=null;
    }
}
