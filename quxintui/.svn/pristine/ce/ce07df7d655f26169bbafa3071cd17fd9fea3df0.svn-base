...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        progress = mTypedArray.getInt(R.styleable.RoundProgressBar_roundProgress, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int radiusX = (int) (centreX - roundWidth / 2);
        int radiusY = (int) (centreY - roundWidth / 2);
        int radius = radiusX < radiusY ? radiusX : radiusY; //圆环的半径
